...
```bash
git clone https://github.com/joaoduenas17/dodge-the-creeps-godot.git
```
...
2. Navega hasta la carpeta donde clonaste o extrajiste el repositorio
...
1. Presiona el botón **Play (▶)** ubicado en la parte superior derecha del editor
